...
| **P3 커뮤니티 게시판** (TipTap·리치 에디터)           | 🟨(진행중) | **프론트 1차 완료** — `/board` 목록·`/board/write`·임시저장 모달·GNB 커뮤니티 탭·TipTap 커스텀 에디터(링크 카드/임베드/Details/리사이즈/한도). **잔여**: 백엔드 게시글 API·읽기/쓰기 실제 연동·상세 화면 완성.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                         |
...
5. **P3 커뮤니티 게시판** — **진행중** — 프론트 1차(에디터·목록·글쓰기·임시저장 모달) 완료, 다음은 **게시글 백엔드 API 및 실제 등록/조회 연동**.  
