...
- **티어 DnD(UX·버그 아님)**: 삽입 앞/뒤가 카드 **가로 중심** 기준이라, 그 선을 넘기 전에 드롭하면 **실제 순서는 그대로**인데 **드래그 그림자만** 움직인 것처럼 보일 수 있음.
...
| Tier Maker — 보드 UX                        | ✅     | DnD·행 정렬·설정 모달·멀티 선택·캡처·라이트/다크·모바일 · **(2026-04-03)** 투명 스페이서(`spacer-`)·풀/행 **Sortable**·카드 가로중심 기준 앞/뒤 삽입·`closestCorners`·`tier-spacer-id`/로컬 `arrayMove`로 RSC 안전                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                      |
