...
6. ~~**Ideal Type 이상형 월드컵**~~ → **1차 완료 (2026-04-22)** — 템플릿 CRUD·플레이·통계·랭킹·허브·에디터·Canvas/GIF/CORS·강수·플레이 진입(`**/worldcup/templates**`·`**/new**`·`**/{id}`**)·플레이 헤더·게이지·대각/좌우 버튼·이미지/유튜브 분기·리롤 에셋 등 — 「진행 메모 (2026-04-20·21·22)」. **백로그**: 템플릿 **공개 정책 DB/API**, **AI 딸깍 → 월드컵** 연동·스트리머 등은 「장기 아이디어」·표 비고.  
